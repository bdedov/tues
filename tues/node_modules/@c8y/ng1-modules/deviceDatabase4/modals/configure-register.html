    ...
    <form ng-if="vm.element" style="margin-top: -16px;" name="vm.elementForm" novalidate>
      ...
      <fieldset ng-if="vm.shouldShowOptions()">
        ...
        <div class="form-group">
          <div ng-if="vm.features.options.signed">
            <label title="{{ 'Signed' | translate }}" class="c8y-checkbox input-sm">
              <input type="checkbox" ng-model="vm.element.signed" />
              <span></span>
              <span>{{ 'Signed' | translate }}</span>
              <i
                class="text-primary"
                c8y-icon="question-circle"
          ...
          <div ng-if="vm.features.options.enumType">
            <label title="{{ 'Enumeration type' | translate }}" class="c8y-checkbox input-sm">
              <input type="checkbox" ng-model="vm.element.meta.enumType" />
              <span></span>
              <span>{{ 'Enumeration type' | translate }}</span>
              <i
                class="text-primary"
                c8y-icon="question-circle"
                uib-tooltip="{{
          ...
          <div ng-if="vm.features.options.bcd">
            <label class="c8y-checkbox input-sm">
              ...
              <span></span>
              <span>{{ 'Packed decimal' | translate }}</span>
              <i
                class="text-primary"
                c8y-icon="question-circle"
          ...
          <div ng-if="vm.features.options.littleEndian && vm.element.noBits > 8">
            <label class="c8y-checkbox input-sm">
              ...
              <span></span>
              <span>{{ 'Little-endian' | translate }}</span>
              <i
                class="text-primary"
                c8y-icon="question-circle"
                uib-tooltip="{{
      ...
      <fieldset ng-if="vm.shouldShowFunctionalities()">
        ...
        <div class="form-group" ng-if="vm.features.functionalities.readWriteMutex">
          <label
            title="{{ 'Show status (read-only)' | translate }}"
            class="radio-inline c8y-radio input-sm"
          >
            <input
              type="radio"
            ...
            />
            <span></span> 
            <span>{{ 'Show status (read-only)' | translate }}</span>
          </label>

          <label
            title="{{ 'Update status (write)' | translate }}"
            class="radio-inline c8y-radio input-sm"
          >
            <input
              type="radio"
            ...
            />
            <span></span>
            <span>{{ 'Update status (write)' | translate }}</span>
          </label>
        </div>
        <div
        ...
        >
          <label
            title="{{ 'Show status (read-only access)' | translate }}"
        ...
        >
          <label
            title="{{ 'Update status (read/write access)' | translate }}"
            class="c8y-checkbox input-sm"
          >
            <input
              type="checkbox"
