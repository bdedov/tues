    ...
    <div class="col-lg-6 col-md-12">
      <div class="card card--fullpage">
        ...
        <div class="inner-scroll">
          <ul class="list-group "
            ng-init="vm.loadOperations()">
            <li class="c8y-stacked-item removable list-group-item"
              ng-repeat="op in vm.operations | orderBy:['name', 'fragment'] track by $index"
            >
              <div class="d-flex p-t-4 p-b-4 p-l-8 p-r-8">
                ...
                <div class="m-l-auto flex-item-middle">
                  <span class="text-label-small">{{'Fragment' | translate}}</span>
                  <span class="text-muted">{{op.fragment}}</span>
                 
                  <button ng-if="op.removable"
        ...
        <script type="text/ng-template" id="confirmDelete.html">
          <div style="white-space: normal;">
            ...
            <p class="m-b-16" translate>Are you sure you want to delete? This operation is irreversible.</p>
            <div class="d-flex">
        ...
        <div class="card-footer separator">
          <button 
            ...
            <i c8y-icon="plus-circle"></i> {{'Add custom operation' | translate}}
          </button>
        </div>
      </div>
    </div>
