...
>
  <uib-accordion-heading class="row">
    <div class="col-sm-1"
    style="align-self: center; padding: 0 10px"
    >
      <i
    ...
    <div class="col-sm-3"
      uib-tooltip="{{ 'Fragment type' | translate }}"
    ...
    <div class="col-sm-3"
      uib-tooltip="{{ 'Maximum age' | translate }}"
      tooltip-placement="left"
    >
    ...
    <div class="col-sm-2 text-right">
      <button class="showOnHover"
        ng-class="{'open': popoverIsOpen}"
        style="font-size: 16px; line-height: 14px"
