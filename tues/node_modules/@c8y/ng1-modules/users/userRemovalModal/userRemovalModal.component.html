<div class="viewport-modal">
  <div class="c8y-prompt alert alert-danger">
    ...
    <div ng-if="vm.hasSubusers" class="p-t-16 p-b-0 separator-top">
      <p class="text-bold">
        {{ 'What would you like to do with sub-users when the owner is deleted?' | translate }}
      </p>
      ...
      <div class="m-b-24">
        ...
        <label class="c8y-radio">
          ...
          <button
            class="btn-clean text-14 m-l-4"
            uib-popover="{{
              'All direct and indirect sub-users of the deleted user are deleted.' | translate
            }}"
            popover-trigger="'focus'"
            popover-placement="right"
            popover-append-to-body="true"
