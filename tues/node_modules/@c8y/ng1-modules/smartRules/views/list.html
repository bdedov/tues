      ...
      <div class="smart-rules-list" ng-if="rules.length > 0">
        <div class="card-group" ng-class="vm.listClass">
          <div class="smart-rules-list-head page-sticky-header p-t-8">
            <label class="smart-rule-group text-center p-t-4" translate>
              Status
            </label>
            <label class="smart-rule-children p-t-4" ng-if="children.length > 0" translate>
              Children
            </label>
            <label class="smart-rule-description p-t-4" translate>
              Smart rule
            </label>
          </div>
                    ...
                    >
                      ...
                      >
                        <i
                          class="fa"
                          ng-class="{
                            'fa-check text-success': hasSource(rule),
                            'fa-ban text-danger': !hasSource(rule)
                          }"
                        ></i>
                        <translate ng-if="hasSource(rule)">
                          Active`rule`
                        </translate>
                        <translate ng-if="!hasSource(rule)">
                          Inactive`rule`
                  ...
                  <div class="smart-rule-details card-inner-scroll">
                    <div class="row">
                      ...
                      <div class="col-sm-9" ng-if="isOpen[rule.id] || isFlipped">
                        ...
                        <div class="bottom-m-md" c8y-audit-list filter="{source: rule.id}"></div>
                      </div>
                    </div>
                  </div>
