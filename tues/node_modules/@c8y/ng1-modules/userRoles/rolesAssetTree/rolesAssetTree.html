<div class="c8y-list__group m-b-0 no-border-last">
  ...
  >
    <div  class="c8y-list__item__block" 
      ng-click="!asset._subGroups && vm.loadChildren(asset)"
      ng-style="::{'padding-left': asset._depth * 8}"
      title="{{vm.title(asset)}}"
    >
      <div class="c8y-list__item__icon m-t-4 p-l-0">
        <i c8y-icon="c8y-group" class="c8y-icon-duocolor" ng-if="!asset._subGroups.length"></i>
        <i c8y-icon="c8y-group-open" class="c8y-icon-duocolor" ng-if="::asset._subGroups.length"></i>
