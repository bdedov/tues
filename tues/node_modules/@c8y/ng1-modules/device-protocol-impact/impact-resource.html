      ...
      <div class="form tight-grid" ng-form="resourceForm">
        ...
        <div class="col-md-4">
          <div class="form-group form-group-sm">
            ...
            <div>
              <label title="{{ 'Single' | translate }}" class="c8y-radio radio-inline">
                <input
                  type="radio"
                  name="multiple"
                  ...
                  ng-value="false"
                />
                <span></span> <span>{{ 'Single' | translate }}</span>
              </label>
              <label title="{{ 'Multiple' | translate }}" class="c8y-radio radio-inline">
                <input
                  type="radio"
                  name="multiple"
                  ng-model="vm.resource.multiple"
                  ng-value="true"
                />
                <span></span> <span>{{ 'Multiple' | translate }}</span>
              </label>
            </div>
