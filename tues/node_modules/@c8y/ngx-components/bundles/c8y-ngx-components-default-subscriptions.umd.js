(function (global, factory) {
    ...
    (global = global || self, factory((global.c8y = global.c8y || {}, global.c8y['ngx-components'] = global.c8y['ngx-components'] || {}, global.c8y['ngx-components']['default-subscriptions'] = {}), global.ng.core, global.ng.forms, global.c8y['ngx-components'], global.lodashEs, global.rxjs.operators, global.client));
    ...
    var DefaultSubscriptionsNavigationFactory = /** @class */ (function () {
        function DefaultSubscriptionsNavigationFactory(defaultSubscriptionsGuard) {
            ...
            this.navNode = new ngxComponents.NavigatorNode({
                ...
                icon: 'c8y-c8y-data',
                parent: ngxComponents.gettext('Applications'),
                priority: 1000
            });
        }
