(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/forms'), require('@angular/router'), require('ngx-bootstrap/collapse'), require('ngx-bootstrap/datepicker'), require('ngx-bootstrap/dropdown'), require('ngx-bootstrap/popover'), require('ngx-bootstrap/timepicker'), require('ngx-bootstrap/tooltip'), require('@c8y/ngx-components'), require('@c8y/ngx-components/device-grid'), require('@c8y/ngx-components/device-profile'), require('@c8y/ngx-components/repository'), require('@c8y/ngx-components/operations/single-operation-details'), require('@c8y/ngx-components/operations/operation-summary'), require('@c8y/ngx-components/operations/bulk-operation-scheduler'), require('lodash-es'), require('rxjs'), require('rxjs/operators'), require('@c8y/ngx-components/operations/bulk-operations-service'), require('@ngx-translate/core'), require('@c8y/client'), require('@c8y/ngx-components/operations/bulk-operations-list'), require('ngx-bootstrap/modal'), require('@angular/cdk/coercion'), require('@angular/common'), require('@c8y/ngx-components/operations/status-filter')) :
    typeof define === 'function' && define.amd ? define('@c8y/ngx-components/operations', ['exports', '@angular/core', '@angular/forms', '@angular/router', 'ngx-bootstrap/collapse', 'ngx-bootstrap/datepicker', 'ngx-bootstrap/dropdown', 'ngx-bootstrap/popover', 'ngx-bootstrap/timepicker', 'ngx-bootstrap/tooltip', '@c8y/ngx-components', '@c8y/ngx-components/device-grid', '@c8y/ngx-components/device-profile', '@c8y/ngx-components/repository', '@c8y/ngx-components/operations/single-operation-details', '@c8y/ngx-components/operations/operation-summary', '@c8y/ngx-components/operations/bulk-operation-scheduler', 'lodash-es', 'rxjs', 'rxjs/operators', '@c8y/ngx-components/operations/bulk-operations-service', '@ngx-translate/core', '@c8y/client', '@c8y/ngx-components/operations/bulk-operations-list', 'ngx-bootstrap/modal', '@angular/cdk/coercion', '@angular/common', '@c8y/ngx-components/operations/status-filter'], factory) :
    (global = global || self, factory((global.c8y = global.c8y || {}, global.c8y['ngx-components'] = global.c8y['ngx-components'] || {}, global.c8y['ngx-components'].operations = {}), global.ng.core, global.ng.forms, global.ng.router, global.collapse, global.datepicker, global.dropdown, global.popover, global.timepicker, global.tooltip, global.c8y['ngx-components'], global.c8y['ngx-components']['device-grid'], global.c8y['ngx-components']['device-profile'], global.c8y['ngx-components'].repository, global.c8y['ngx-components'].operations['single-operation-details'], global.c8y['ngx-components'].operations['operation-summary'], global.c8y['ngx-components'].operations['bulk-operation-scheduler'], global.lodashEs, global.rxjs, global.rxjs.operators, global.c8y['ngx-components'].operations['bulk-operations-service'], global.core$1, global.client, global.c8y['ngx-components'].operations['bulk-operations-list'], global.modal, global.ng.cdk.coercion, global.ng.common, global.c8y['ngx-components'].operations['status-filter']));
}(this, (function (exports, core, forms, router, collapse, datepicker, dropdown, popover, timepicker, tooltip, ngxComponents, deviceGrid, deviceProfile, repository, singleOperationDetails, operationSummary, bulkOperationScheduler, lodashEs, rxjs, operators, bulkOperationsService, core$1, client, bulkOperationsList, modal, coercion, common, statusFilter) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var BulkOperationStepper = /** @class */ (function () {
        ...
        __decorate([
            core.ContentChildren(CustomStep)
        ...
        __decorate([
            core.ViewChild(OperationDetailsComponent, { static: false })
    ...
    var BaseStepperComponent = /** @class */ (function () {
        ...
        __decorate([
            core.ViewChild(BulkOperationStepper, { static: true })
    ...
    var VersionOrPatchComponent = /** @class */ (function () {
        function VersionOrPatchComponent(repositoryService, inventoryService, bulkOpsService) {
            ...
            this.elementCount = 0;
            this.DD_LOW_COUNT = 10;
            this.firmware$ = this.bulkOpsService.firmwareId.pipe(operators.distinctUntilChanged(), operators.switchMap(function (id) { return _this.inventoryService.detail$(id).pipe(operators.catchError(function (error) { return rxjs.of(error); })); }), operators.shareReplay(1));
        ...
        VersionOrPatchComponent.prototype.getBaseVersionAndPatches$ = function (baseVersion) {
            var _this = this;
            return this.firmware$.pipe(operators.distinctUntilKeyChanged('id'), operators.switchMap(function (firmware) {
    ...
    var SelectSoftwareStepComponent = /** @class */ (function () {
        ...
        __decorate([
            core.ViewChildren(ngxComponents.ListItemRadioComponent)
    ...
    var StepperBulkTypeSoftware = /** @class */ (function (_super) {
        ...
        __decorate([
            core.ViewChild(SelectSoftwareStepComponent, { static: false })
    ...
    var OperationSchedulerComponent = /** @class */ (function () {
        function OperationSchedulerComponent(formBuilder) {
            this.formBuilder = formBuilder;
            this.placeholder = ngxComponents.gettext('Start date');
        ...
        OperationSchedulerComponent.prototype.ngOnInit = function () {
            ...
            this.fgOperationScheduler = this.formBuilder.group({
                picker: ['', [forms.Validators.required, this.dateValidation]],
                time: ['', [forms.Validators.required, this.timeValidation]],
                delay: ['', [forms.Validators.required, forms.Validators.min(this.minDelay)]],
                unit: ['seconds']
            });
            ...
            var valueChanges$ = this.fgOperationScheduler.valueChanges.pipe(operators.throttleTime(100));
        ...
        OperationSchedulerComponent.prototype.convertDelayHandler = function (unit) {
            ...
            this.fgOperationScheduler.controls.delay.setValidators([forms.Validators.required]);
        ...
        OperationSchedulerComponent.prototype.timeValidation = function (fControl) {
            if (fControl.value) {
                ...
                if (picker && picker.errors && picker.errors.dateValidation) {
                    ...
                    if (lodashEs.isEmpty(picker.errors)) {
                ...
                providers: [
                    {
                        ...
                        multi: true,
                        useExisting: core.forwardRef(function () { return OperationSchedulerComponent_1; })
                    },
                    {
    ...
    var BulkOperationSchedulerModule = /** @class */ (function () {
        ...
        BulkOperationSchedulerModule = __decorate([
            core.NgModule({
                imports: [ngxComponents.CoreModule, forms.ReactiveFormsModule, datepicker.BsDatepickerModule, timepicker.TimepickerModule],
                providers: [],
    ...
    var SingleOperationListItemComponent = /** @class */ (function () {
        ...
        __decorate([
            core.ViewChild('historyOfChanges', { static: true })
    ...
    var C8Y_BULK_TYPES = [
        {
            type: exports.BulkOperationType.CONFIGURATION,
            c8yIcon: 'cogs',
            name: ngxComponents.gettext('Configuration update'),
        ...
        {
            type: exports.BulkOperationType.FIRMWARE,
        ...
        {
            type: exports.BulkOperationType.SOFTWARE,
            c8yIcon: 'c8y-tools',
            name: ngxComponents.gettext('Software update'),
        ...
        {
            type: exports.BulkOperationType.DEVICE_PROFILE,
    ...
    var BulkOperationsService = /** @class */ (function () {
        ...
        BulkOperationsService.ctorParameters = function () { return [
            ...
            { type: Array, decorators: [{ type: core.Inject, args: [HOOK_LIST_BULK_TYPE,] }] }
        ]; };
        BulkOperationsService = __decorate([
            core.Injectable(),
            __param(4, core.Inject(HOOK_LIST_BULK_TYPE))
    ...
    exports.BulkOperationSchedulerModule = BulkOperationSchedulerModule;
    ...
    exports.C8Y_BULK_TYPES = C8Y_BULK_TYPES;
    exports.C8Y_BULK_TYPE_FRAGMENTS = C8Y_BULK_TYPE_FRAGMENTS;
    ...
    exports.OperationSchedulerComponent = OperationSchedulerComponent;
    ...
    exports.StepperBulkTypeConfiguration = StepperBulkTypeConfiguration;
    exports.StepperBulkTypeDeviceProfile = StepperBulkTypeDeviceProfile;
    exports.StepperBulkTypeSoftware = StepperBulkTypeSoftware;
    exports.StepperFirmware = StepperFirmware;
