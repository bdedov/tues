...
msgstr "将面板应用于类型为 <i>{{ dashboard.deviceTypeValue }}</i> 的所有设备"
...
msgstr "在下面可以配置一台或多台 OPC UA 服务器。如果启用这些服务器，并且连接状态设置为 \"已连接\"，则 OPC UA 代理将连接到这些服务器。"
...
msgstr "用于为导航器徽标设置正确比例的高度：高度/宽度 x 100 - 应为 230 像素宽"
...
msgstr ""
"每小时：过去\n"
"                    小时的 {{ schedule.cronConfig.minute | number: '2.0-0' }} 分钟。"
...
msgstr ""
"默认应用程序适用于租户的所有用户。从下面的列表中选择默认应用程序\n"
"          并确保所有用户均可访问此应用程序。"
...
"                    }}."
msgstr ""
"每周：{{ cronService.getWeekDayName(schedule.cronConfig) }}，在\n"
"                    {{ schedule.cronConfig.hour | number: '2.0-0' }}:{{\n"
"                      schedule.cronConfig.minute | number: '2.0-0'\n"
"                    }}。"
...
msgstr "如应用于类型为 c8y_Linux 的设备的云连接软件"
...
msgstr "如应用于类型为 c8y_Linux 的设备的设备配置文件"

msgid "e.g. Device profile for c8y_Linux devices"
msgstr "如 c8y_Linux 设备的设备配置文件"
...
msgstr "如应用于类型为 c8y_Linux 的设备的硬件修订版 b 的固件"
...
msgstr "如应用于类型为 c8y_Linux 的设备的主机配置"

msgid "e.g. Host configuration c8y_Linux"
msgstr "如主机配置 c8y_Linux"
...
msgstr "例如 joe.doe@example.cn（单个电子邮件地址）"
...
msgstr "允许 {{ limit }} 中的 {{ count }} 个选定项目"
