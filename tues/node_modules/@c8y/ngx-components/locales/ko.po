...
msgstr "생성시 테넌트에 구독된 애플리케이션"

msgid "Applications subscribed to a tenant on platform upgrade"
msgstr "플랫폼을 업그레이드할 때 테넌트에 구독된 애플리케이션"
...
msgstr "<i>{{ dashboard.deviceTypeValue }}</i> 유형의 모든 디바이스에 대시보드 적용"
...
msgstr "아래에서는 하나 이상의 OPC UA 서버를 구성할 수 있습니다. OPC UA 에이전트는 활성화되고 연결 상태가 \"연결됨\"으로 설정되면 이러한 서버에 연결할 수 있습니다."
...
"            inherited settings."
msgstr ""
"테넌트 생성 및 플랫폼 업그레이드 모두를 위한 플랫폼에서의\n"
"            기본 구독을 구성합니다. 사용 가능한 애플리케이션 전체 목록을 표시하려면\n"
"            상속한 설정을 무시하십시오."
...
"                    }}."
msgstr ""
"매일: 시간:{{ schedule.cronConfig.hour | number: '2.0-0' }}:{{\n"
"                    schedule.cronConfig.minute | number: '2.0-0'\n"
"                  }}."
...
msgstr "역할이 있는 사용자에 대해 2단계 인증 시행"
...
msgstr ""
"자세한 내용은\n"
"        <a c8y-guide-href=\"users-guide/administration/#reprio-alarms\">User guide</a>을 참조하십시오."
...
msgstr "내비게이터 로고의 오른쪽 부분 설정 높이: 높이/너비 x 100 - 230픽셀 너비여아 함"
...
"                    }}."
msgstr ""
"매월: {{ cronService.getMonthDayName(schedule.cronConfig) }}일\n"
...
msgstr "구성된 디바이스 유형이 없습니다. 디바이스 데이터베이스를 사용하여 Actility LoRa 디바이스 유형을 생성하십시오."
...
msgstr "일치하는 항목이 없습니다. 새 를 추가하시겠습니까?"
...
msgstr "검색을 위해 디바이스의 ID나 이름을 입력합니다."
...
msgstr ""
"당사는 어떤 개인 데이터도 수집하지 않습니다.\n"
"            사용자의 전화기에서 검색하는 정보는 센서 데이터와 익명화된 앱 사용 데이터뿐입니다."
...
"                    }}."
msgstr ""
"매주: {{ cronService.getWeekDayName(schedule.cronConfig) }}, 시간: \n"
"                    {{ schedule.cronConfig.hour | number: '2.0-0' }}:{{\n"
"                      schedule.cronConfig.minute | number: '2.0-0'\n"
"                    }}."
...
"                    }}."
msgstr ""
"매년: {{ cronService.getMonthName(schedule.cronConfig) }},\n"
...
msgstr "선택한 보고서의 다운로드 링크가 포함된 이메일이 전송됩니다."
...
msgstr "예: MyType, 별표(*)를 와일드카드 문자로 사용할 수 있습니다."
...
msgstr "예: joe or joe.doe@example.ko"

msgid "e.g. joe.doe@example.com (single email address)`LOCALIZE`"
msgstr "예: joe.doe@example.ko (단일 이메일 주소)"

msgid "e.g. joe.doe@example.com`LOCALIZE`"
msgstr "예: joe.doe@example.ko"
...
msgstr "허용되는 {{ limit }}개 중 {{ count }}개 항목 선택"
