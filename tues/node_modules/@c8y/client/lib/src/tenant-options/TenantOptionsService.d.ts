import { Service, IResultList, IResult, IIdentified, IObservableOptions } from '../core';
...
export declare class TenantOptionsService extends Service<ITenantOption> {
     ...
     */
    list$(filter?: object, options?: IObservableOptions): import("rxjs").Observable<ITenantOption[]>;
    /**
