import { IFetchClient, IIdentified, Service, IResult, IResultList, IObservableOptions } from '../core';
...
export declare class UserInventoryRoleService extends Service<IUserInventoryRole> {
     ...
     */
    list$(filter?: object, options?: IObservableOptions): import("rxjs").Observable<IUserInventoryRole[]>;
    /**
