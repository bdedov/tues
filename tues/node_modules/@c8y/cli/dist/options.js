...
exports.options = {
    ...
    'TXT.SERVER.CUSTOM_PROXY_PATHS': 'Allows to set a custom RegEx for additional paths to be proxied to the tenant. If option is not provided the default RegEx will proxy requests to /apps/public/... to the tenant. If option is used without an argument, the default proxy for /apps/public/...  will be disabled.',
