...
class ServerCommand extends Commands_1.Commands {
    ...
    async action(_appPaths, command) {
        try {
            const devServer = new webpack_1.DevServer(this.getOption('url'), this.getOption('port'), this.getOption('ssl'), this.getOption('domain'), this.getOption('customProxyPaths'));
