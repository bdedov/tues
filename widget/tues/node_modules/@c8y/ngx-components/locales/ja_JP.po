...
msgstr "作成時にテナントにサブスクライブされたアプリケーション"

msgid "Applications subscribed to a tenant on platform upgrade"
msgstr "プラットフォームの更新時にテナントにサブスクライブされたアプリケーション"
...
msgstr "すべてのデバイス タイプ <i>{{ dashboard.deviceTypeValue }}</i> にダッシュボードを適用"
...
"            inherited settings."
msgstr ""
"テナント作成とプラットフォーム更新の両方に関して、\n"
"            プラットフォームでデフォルトのサブスクリプションを設定してください。使用可能なすべてのアプリケーションの全リストを表示するには、\n"
"            継承された設定を上書きしてください。"
...
msgstr "ナビゲーターのロゴに適切な比率を設定するための高さ: 高さ / 幅 × 100 - 230 ピクセル幅である必要があります"
...
"                    }}."
msgstr ""
"毎月: {{ cronService.getMonthDayName(schedule.cronConfig) }} 日\n"
...
"          デフォルト アプリケーションを選択して、すべてのユーザーがこのアプリケーションにアクセスできることを確認してください。"
...
"                    }}."
msgstr ""
"毎週: {{ cronService.getWeekDayName(schedule.cronConfig) }}, at\n"
"                    {{ schedule.cronConfig.hour | number: '2.0-0' }}:{{\n"
"                      schedule.cronConfig.minute | number: '2.0-0'\n"
"                    }}。"
...
"                    }}."
msgstr ""
"毎年: {{ cronService.getMonthName(schedule.cronConfig) }}、\n"
"毎月                    {{ cronService.getMonthDayName(schedule.cronConfig) }} 日、\n"
"                    {{ schedule.cronConfig.hour | number: '2.0-0' }}:{{\n"
"                      schedule.cronConfig.minute | number: '2.0-0'\n"
"                    }}。"
...
msgstr "選択したレポートのダウンロード リンクを記載したメールが送信されます。"
...
msgstr "(例) taro.yamada@example.co.jp (単一 Eメール アドレス)"
